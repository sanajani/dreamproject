  ...
  return (
    <div className=" min-h-[90vh] bg-gray-300">
      ...
      <form className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 bg-white rounded-md pt-3 pb-10">
        <h1 className="sm:col-span-2 text-center text-3xl py-4">Hello dear Sana please fill the form</h1>
        ...
        <button className="bg-green-500 py-3 text-xl rounded-md w-fit px-10 text-white mx-1 font-bold">hello</button>
      </form>
      </div>
    </div>
  )
